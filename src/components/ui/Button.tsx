...
const base =
  "group relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full font-semibold tracking-[0.01em] transition-all duration-300 ease-chef disabled:pointer-events-none disabled:opacity-45 select-none";
