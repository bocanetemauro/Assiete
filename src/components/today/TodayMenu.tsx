      ...
      <section className="paper-grain relative overflow-hidden bg-paper">
        <div className="container-page grid gap-14 py-14 lg:grid-cols-[1fr_0.95fr] lg:items-center lg:gap-20 lg:py-24">
          ...
          <motion.div
            ...
            className="relative mx-auto w-full max-w-lg rounded-[6px] bg-cream p-3 shadow-lift"
          >
            <div className="rounded-[3px] border border-ink/15 p-2">
              <div className="border border-ink/10 px-6 py-10 text-center sm:px-10">
                    ...
                    <li key={r.id}>
                      <Link href={`/recepten/${r.slug}`} className="group block">
                        ...
                        <span className="mt-1 flex items-center gap-2 text-[12.5px] text-muted">
                          <span className="flex-1 truncate text-right italic">{r.subtitle}</span>
                          <span className="h-px w-6 border-t border-dotted border-muted/60" />
                          <span className="flex-1 text-left tabular-nums">{formatMinutes(r.totalMinutes)}</span>
                        </span>
                      </Link>
                    </li>
                  ))}
