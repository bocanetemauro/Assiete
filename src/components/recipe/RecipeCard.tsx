        ...
        <div className="flex flex-col justify-center gap-6 p-7 sm:p-10 lg:p-14">
          ...
          <dl className="grid grid-cols-3 gap-4 border-y border-line py-5">
            <div>
              ...
              <dd className="mt-1.5 font-serif text-2xl">{formatMinutes(recipe.totalMinutes)}</dd>
            </div>
            <div>
              <dt className="eyebrow text-[9.5px] text-muted">Niveau</dt>
              <dd className="mt-1.5 font-serif text-2xl">{DIFFICULTY_LABEL[recipe.difficulty]}</dd>
            </div>
            <div>
              <dt className="eyebrow text-[9.5px] text-muted">Personen</dt>
              <dd className="mt-1.5 font-serif text-2xl">{recipe.servings}</dd>
            </div>
          </dl>
